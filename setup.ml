...
(* OASIS_START *)
(* DO NOT EDIT (digest: 39e1b4d8512706eb68627ad1a600d8b2) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Solver"; "Algebra"; "Typ"; "Id"];
                      lib_pack = true;
                      lib_internal_modules = ["Util"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "u-\214\011\1321\177\031\224#[\248\r\027\t\139";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
