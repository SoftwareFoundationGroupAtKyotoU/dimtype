...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9ac402d42cd1ce200ca0882cb08a9325) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   },
                   {
                      lib_modules = ["Infer"];
                      lib_pack = false;
                      lib_internal_modules = ["Util"; "Algebra"; "Typ"; "Id"];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "infer.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "3\011i_K43oa’grœ*U4";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
