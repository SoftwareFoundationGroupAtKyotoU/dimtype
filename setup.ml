...
(* OASIS_START *)
(* DO NOT EDIT (digest: 727cfb37779be5b5665d47ea5d3b1159) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Dimtype"; "Algebra"];
                      lib_pack = false;
                      lib_internal_modules = ["Util"; "Typ"; "Id"];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for dimtype";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "dimtype"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "imp.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\tÂ\150g¡\149\141\147\140.\131\150\015'ð\020";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
